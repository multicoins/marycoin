...
void ArgsManager::ReadConfigFile(const std::string& confPath)
{
    ...
    if (!streamConfig.good())
        return; // No marycoin.conf file is OK

    {
        ...
        {
            // Don't overwrite existing settings so command line settings override marycoin.conf
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Marycoin Core copyright is not removed by accident
