 ...
 * between marycoind, and marycoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/multicoins/marycoin>";
    const std::string URL_WEBSITE = "<https://marycoin.org>";
