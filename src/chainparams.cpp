...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 3803;
        consensus.BIP34Hash = uint256S("0x000000000000010c21a7ee49b43b5c4ebdf06e6291c8e2ea8acf36a3bfb671ed");
        consensus.BIP65Height = 3803; // 000000000000010c21a7ee49b43b5c4ebdf06e6291c8e2ea8acf36a3bfb671ed
        consensus.BIP66Height = 3803; // 000000000000010c21a7ee49b43b5c4ebdf06e6291c8e2ea8acf36a3bfb671ed
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000484fe0fac171915aa");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000000000010c21a7ee49b43b5c4ebdf06e6291c8e2ea8acf36a3bfb671ed"); //3803
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 3803, uint256S("0x000000000000010c21a7ee49b43b5c4ebdf06e6291c8e2ea8acf36a3bfb671ed"))
        };

        chainTxData = ChainTxData{
            // Data as of block 000000000000010c21a7ee49b43b5c4ebdf06e6291c8e2ea8acf36a3bfb671ed (height 3803).
            1499630957, // * UNIX timestamp of last known number of transactions
            16792,  // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 546, uint256S("00000000bb9fb8ac0c6e7d49cd45d25be8cca7065233820d7eff340476be3875")),
        };
